define([
	...
	"dojo/when",
	"./getPlainValue"
], function(declare, lang, when, getPlainValue){
	return declare("dojox.mvc.EditStoreRefControllerMixin", null, {
		// summary:
		//		A mixin class to the combination of dojox/mvc/ModelRefController, dojox/mvc/EditModelRefControllerMixin and dojox/mvc/StoreRefControllerMixin, managing edits.
		// description:
		//		In addition to what the combination of dojox/mvc/ModelRefController, dojox/mvc/EditModelRefControllerMixin and dojox/mvc/StoreRefControllerMixin does, the commit() method sends the data model as well as the removed entries in array to the data store.
		// example:
		...
		// |				<span id="ctrl" data-dojo-type="dojox/mvc/ModelRefController" data-dojo-mixins="dojox/mvc/EditModelRefControllerMixin,dojox/mvc/StoreRefControllerMixin,dojox/mvc/EditStoreRefControllerMixin,dojox/mvc/ListControllerMixin"
