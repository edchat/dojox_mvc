...
try{
	...
	doh.registerUrl("dojox.mvc.tests.doh_async_mvc_14491-input-output", dojo.moduleUrl("dojox.mvc","tests/doh_async_mvc_14491-input-output.html"+userArgs), 999999);	doh.registerUrl("dojox.mvc.tests.doh_mvc_template_repeat_exprchar", dojo.moduleUrl("dojox.mvc","tests/doh_mvc_template_repeat_exprchar.html"+userArgs), 999999);
